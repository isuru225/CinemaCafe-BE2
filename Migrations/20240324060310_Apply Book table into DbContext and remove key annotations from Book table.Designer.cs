...
namespace MovieAppBackend.Migrations
{
    ...
    [Migration("20240324060310_Apply Book table into DbContext and remove key annotations from Book table")]
    partial class ApplyBooktableintoDbContextandremovekeyannotationsfromBooktable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieAppBackend.Models.Book", b =>
                {
            ...
            modelBuilder.Entity("MovieAppBackend.Models.Book", b =>
                {
                    ...
                    b.HasOne("MovieAppBackend.Models.MovieItem", "MovieItem")
                        .WithMany()
                        .HasForeignKey("MovieItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieAppBackend.Models.Theater", "Theater")
                        .WithMany()
                        .HasForeignKey("TheaterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieAppBackend.Models.User", "User")
                        .WithMany()
